google-cloud-bucket-c
=====================
[![CI for Linux, Windows, macOS](https://github.com/offscale/google-cloud-bucket-c/actions/workflows/linux-Windows-macOS.yml/badge.svg)](https://github.com/offscale/google-cloud-bucket-c/actions/workflows/linux-Windows-macOS.yml)
[![License](https://img.shields.io/badge/license-Apache--2.0%20OR%20MIT-blue.svg)](https://opensource.org/licenses/Apache-2.0)

Google Cloud Bucket Client library in C. TODO: replace C wrapper of official C++ client library with custom low-dependency variant.
...
[Install vcpkg](https://vcpkg.io/en/getting-started.html), configure it with your system. Then run:
    ...
    [root]/vcpkg/vcpkg install google-cloud-cpp
